...
const uiDir = path.join(path.dirname(require.resolve('recursive-react-docs-ai/package.json')), 'src', 'ui');
...
console.log('UI directory found at: ' + uiDir);
...
const server = app.listen(port, () => {
  ...
  console.log('Starting Next.js on port ' + nextjsPort);
